  ...
  config: {
    ...
    translations: {
      'ru-RU': {
        ...
        "app.components.MarketplaceBanner.link": "Проверьте это сейчас",
        ...
        "components.FilterOptions.FILTER_TYPES.$notNull": "не равно null",
        "components.FilterOptions.FILTER_TYPES.$null": "равно null",
        ...
        "content-manager.components.TableDelete.label": "{number, plural, one {# entry} other {# entries}} выбрано",
        ...
        "content-manager.containers.Edit.information.by": "по",
        ...
        "content-manager.pages.ListView.header-subtitle": "{number, plural, =0 {# объектов} one {# объект} other {# объектов}} найдено",
        ...
        "content-manager.popUpWarning.bodyMessage.contentType.delete.all": "Вы уверенны, что хотите удалить эти записи?",
        "content-manager.popUpWarning.warning.cancelAllSettings": "Вы уверенны, что хотите отменить ваши изменения?",
        ...
        "content-manager.utils.data-loaded": "{number, plural, =1 {запись} other {записи}} успешно загружено",
